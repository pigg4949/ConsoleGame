...
public class Stage3 {
    ...
    public Stage3(Player player, Scanner sc, String partnerName) {
        this.player = player;
        this.sc = sc;
    ...
    private void playMale() {
        ...
        // Q1
        System.out.println(partnerName + ": \"오늘 너무 많이 걸은 것 같아요. 잠깐 저기 벤치에 앉아서 쉬는 게 어떨까요?\"");
        ...
        // Q2
        System.out.println(partnerName + ": \"바람도 선선하니 좋네요……. 공원 같은 데 자주 오시나요?\"");
        ...
        // Q3
        System.out.println(partnerName + ": \"혹시… 사랑이 오래 지속되기 위해 가장 필요한 게 있다면, 무엇일 거라고 생각하세요?\"");
        ...
        // Q4 분기
        if (branch == 1) {
            System.out.println(partnerName + ": “혹시 지금까지 누군가에게 정말 솔직하게 마음을 털어놓은 적 있으세요?”");
            ...
            System.out.println(partnerName + ": “상대가 연락이 잘 안 돼도 이해할 수 있는 편이세요?”");
            ...
            System.out.println(partnerName + ": “매일 노력하는 사랑이라면 끝내는 지칠 수도 있지 않을까요?”");
        ...
        // Q5
        System.out.println(partnerName + ": “마지막으로… 오늘 하루, 어떠셨어요?”");
        System.out.println("1. 오늘 함께해서 정말 좋았어요. 누나랑/하늘 씨랑 다시 이런 하루를 보내고 싶어요.");
        ...
        if      (aff < 20) System.out.println("실패 엔딩: 관계가 이어지지 않습니다.");
        else if (aff < 40) System.out.println("지인 엔딩: 매너는 있었지만 연애는 없었다.");
        else if (aff < 70) System.out.println("남사친 엔딩: 좋은 친구로 남고 싶어요.");
        else               System.out.println("남친 엔딩: 해피 엔딩! 다음 주말에 또 만날래요?");
        System.out.println("=========================\n");
    }
