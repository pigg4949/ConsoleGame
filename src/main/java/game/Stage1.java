...
import util.color.FirstWomanArt;
...
public class Stage1 {
    ...
    public Result play() {
        ...
        if (isMale) {
            ...
            SoundUtil.playBGM("noise.mp3");
            // Q1
            System.out.println("Stage 1\n");

            // 컷신 출력 추가
            if (partnerName.equals("Easy혜")) {
                var Easy1WomancolorMap = FirstWomanArt.getColorMap(FirstWomanArt.CharacterStyle.EASY_WOMAN);
                printFromResource("/arts/Fnpc1.txt", Easy1WomancolorMap);
            } else if (partnerName.equals("조심혜")) {
                var Normal1WomancolorMap = FirstWomanArt.getColorMap(FirstWomanArt.CharacterStyle.NORMAL_WOMAN);
                printFromResource("/arts/Fnpc1.txt", Normal1WomancolorMap);
            } else {
                var Hard1WomancolorMap = FirstWomanArt.getColorMap(FirstWomanArt.CharacterStyle.HARD_WOMAN);
                printFromResource("/arts/Fnpc1.txt", Hard1WomancolorMap);
            }
            ...
            System.out.printf(player.getName() + ": 안녕하세요, 혹시 오늘 이찬환님 소개로 나오신 %s님 맞으세요??\n", partnerName);
            ...
            if (partnerName.equals("남상규")) {
                var Easy1MancolorMap = FirstManArt.getColorMap(FirstManArt.CharacterStyle.EASY_MAN);
                printFromResource("/arts/Mnpc1.txt", Easy1MancolorMap);
            } else if (partnerName.equals("전중안")) {
                var Normal1MancolorMap = FirstManArt.getColorMap(FirstManArt.CharacterStyle.NORMAL_MAN);
                printFromResource("/arts/Mnpc1.txt", Normal1MancolorMap);
            } else {
                var Hard1MancolorMap = FirstManArt.getColorMap(FirstManArt.CharacterStyle.HARD_MAN);
                printFromResource("/arts/Mnpc1.txt", Hard1MancolorMap);
            }
            // Q1
