        ...
        switch (style) {
            case EASY_WOMAN -> {
                return Map.ofEntries(
                        ...
                        entry('M', new TextColor.RGB(83, 123, 114)),
                        entry('B', new TextColor.RGB(190,200,130)),  // 올리브 옅은 초록
                        entry('5', new TextColor.RGB(180, 140, 100)), // 밝은 갈색
                        entry('r', new TextColor.RGB(245, 245, 245)),
                        entry('9', new TextColor.RGB(140,30,60)),    // 짙은 레드와 버건디
                        // 배경
                        ...
                        // 기타 중간톤 색상들 섞기
                        entry('2', new TextColor.RGB(210,210,160)),  // 연한 베이지
            ...
            case NORMAL_WOMAN -> {
                return Map.ofEntries(
                        // 잎 색
                        entry('B', TextColor.ANSI.GREEN),
                        entry('M', TextColor.ANSI.GREEN_BRIGHT),
                        ...
                        // 밝은 하이라이트
                        entry('s', new TextColor.RGB(240,200,255))  // 라이트 퍼플 하이라이트
                );
            }
            case HARD_WOMAN -> {
                return Map.ofEntries(
                        // 잎 색
                        entry('M', new TextColor.RGB(170,230,200)),
                        entry('B', TextColor.ANSI.GREEN),
                        entry('r', new TextColor.RGB(245, 245, 245)), // 머리: 어두운 카키
                        // 배경
                        entry(',', new TextColor.RGB(255, 245, 200)),
                        // 어두운 갈색 / 의상 테두리
                        entry('G', new TextColor.RGB(0, 166, 149)),
                        entry('X', new TextColor.RGB(45,35,90)),      // 어두운 남색
                        entry('S', new TextColor.RGB(55,30,75)),      // 짙은 보라
                        // 중간톤 초록
                        entry('9', TextColor.ANSI.BLUE),
                        entry('5', TextColor.ANSI.BLUE_BRIGHT),
                        entry('2', new TextColor.RGB(100,0,80)),
